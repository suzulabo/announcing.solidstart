...
/*# sourceURL="https://announcing.app/Announcing.json" */;
let vErrors = null;
let errors = 0;
if(errors === 0){
...
let data6 = data1.header;
const _errs18 = errors;
if((typeof data6 !== "string") && (data6 !== null)){
validate10.errors = [{instancePath:instancePath+"/info/header",schemaPath:"#/properties/info/properties/header/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
if(errors === _errs18){
if(errors === _errs18){
...
if(func2(data6) > 2000){
validate10.errors = [{instancePath:instancePath+"/info/header",schemaPath:"#/properties/info/properties/header/maxLength",keyword:"maxLength",params:{limit: 2000},message:"must NOT have more than 2000 characters"}];
return false;
}
else {
if(!(formats2.test(data6))){
validate10.errors = [{instancePath:instancePath+"/info/header",schemaPath:"#/properties/info/properties/header/format",keyword:"format",params:{format: "uri-reference"},message:"must match format \""+"uri-reference"+"\""}];
return false;
}
}
}
...
let missing2;
if((data8.published === undefined) && (missing2 = "published")){
...
if(data8.published !== undefined){
let data9 = data8.published;
...
if(valid3){
if(data8.body !== undefined){
let data11 = data8.body;
...
if(valid3){
if(data8.img !== undefined){
let data12 = data8.img;
...
if(valid3){
if(data8.imgs !== undefined){
let data13 = data8.imgs;
...
let missing3;
if(((data17.href === undefined) && (missing3 = "href")) || ((data17.count === undefined) && (missing3 = "count"))){
...
let data18 = data17.href;
const _errs52 = errors;
if(errors === _errs52){
if(errors === _errs52){
if(typeof data18 === "string"){
if(func2(data18) > 2000){
...
export const AnnouncingPostsJSONValidator = validate11;
const schema12 = {"$id":"https://announcing.app/AnnouncingPosts.json","$schema":"http://json-schema.org/draft-07/schema#","type":"array","items":{"type":"object","required":["published"],"properties":{"published":{"type":"string","format":"date-time","minLength":1,"maxLength":30,"nullable":false},"title":{"type":"string","nullable":true,"maxLength":100},"body":{"type":"string","nullable":true,"maxLength":1000},"img":{"type":"string","nullable":true,"maxLength":2000,"format":"uri-reference"},"imgs":{"type":"array","nullable":true,"maxItems":10,"uniqueItems":true,"items":{"type":"string","nullable":false,"minLength":1,"maxLength":2000,"format":"uri-reference"}},"link":{"type":"string","nullable":true,"maxLength":2000,"format":"uri-reference"}}}};

function validate11(data, {instancePath="", parentData, parentDataProperty, rootData=data}={}){
/*# sourceURL="https://announcing.app/AnnouncingPosts.json" */;
let vErrors = null;
let errors = 0;
if(errors === 0){
